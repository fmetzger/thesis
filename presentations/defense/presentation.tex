...
\begin{frame}
	...
	\begin{itemize}
		\item Reliable streaming services have largely supplanted RTP-based ones in the Internet
		\item Mobile network traffic share increasing rapidly
		\item But what about the influence of the mobile core network and control plane?
		\item Interaction of reliable streaming and mobile control plane?
		\item Measurement and modeling approaches?
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=5.5cm]{../../chapters/041-mobilenetsmeasuring/images/R-duration-timeofday-ecdf.pdf}
	\end{center}
...
\begin{frame}
	\frametitle{Monolithic GGSN Queuing Model}
		\begin{center}
			\includegraphics[height=3.5cm]{../../chapters/041-mobilenetsmeasuring/images/ggsn-monolithic.pdf}
		\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=6cm]{../../chapters/041-mobilenetsmeasuring/images/R-virtualized-instanceuse.pdf}
	\end{center}
...
\begin{frame}
	\begin{figure}
		\centering
		\includegraphics[height=7cm]{../../chapters/041-mobilenetsmeasuring/images/R-createspersecond-1h-violin.pdf}
