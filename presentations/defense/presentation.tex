...
\begin{frame}
	...
	\begin{itemize}
		\item Reliable streaming has different traffic patterns than RTP/UDP
...
\begin{frame}
	...
	\Put(200,20){\includegraphics[height=2.1cm]{../../chapters/04-mobilenets/images/umts-network.pdf}}
...
\begin{frame}
	...
	\begin{itemize}
		\item If network QoS is too bad, no strategy can safe quality
		\item TCP generally interacts unpredictably with loss, strategies have little influence
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Mobile networks and control plane are complex and can influence the streaming protocol layers in unforeseen ways
