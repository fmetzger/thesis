...
\begin{frame}
	...
	\Put(105,200){\includegraphics[height=3cm]{extras/r-cisco-vni-2014.pdf}}
	\Put(50,40){\fcolorbox{black}{white}{Handling of load and streaming traffic patterns?}}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Separation of user and control plane, complex signaling
	...
	\begin{itemize}
		...
		\item Creation of easy-to-use mobile streaming measurement approaches
	\end{itemize}
	\end{block}
\end{frame}
...
%     	\begin{column}[T]{5cm}
% 			\begin{itemize}
% 				%\item Looking at UMTS/3G in particular%, but GSM/GPRS almost the same
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Search for control plane bottlenecks
...
\begin{frame}
	...
	\end{center}
	\vspace{3em}
	% \Put(200,45){\includegraphics[height=2.1cm]{../../chapters/04-mobilenets/images/umts-network.pdf}}
	% \pause
	% \begin{block}{Device identification}
	% \begin{itemize}
	...
	% 	\item TAC allows (partial) differentiation of the OS (e.g. Android and iOS)
	% \end{itemize}
	% \end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Evaluate blocking probability based on tunnel capacity
	...
	\begin{itemize}
		...
		%\item Negligible virtualization overhead, but potential energy efficiency gains
		\item Usage as GGSN dimensioning tool for operators
		\item Virtualized GGSN with better scaling options possible
...
\begin{frame}
	...
	% \begin{itemize}
	% 	\item Numerous in-the-wild streaming clients and approaches %(progressive, segmented, server-side pacing, adaptive, \ldots)
...
% \begin{frame}
% 	\frametitle{Video Streaming Categorization Criteria}
...
% 				\item Explicit through providing multiple quality levels 
% 			\end{itemize}
...
% 			\begin{itemize}
% 				\item Reliability
% 				\item Multiplexing/multicasting abilities
% 			\end{itemize}
% 	\end{itemize}
	% Pure Progressive
	% Segmented
...
\begin{frame}
	...
	\begin{itemize}
		...
		%\item Simply tested for certain BW, delay, loss ranges
		\item Complex mobile signaling interacts with streaming %in unforeseen ways
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Create a reliable streaming LTE network scenario
	...
	\end{itemize}
		...
		\begin{itemize}
			...
			\item Moving back and forth between them
		\end{itemize}
...
% 	\framesubtitle{Server Link Latency and Bandwidth}

% 	\begin{itemize}
% 		\item Measure num/length of stalls, calculate MOS
% 		\item Suspected bufferbloat issues at high bandwidths
% 	\end{itemize}
...
\begin{frame}
	...
	% 	\begin{itemize}[<2->]
	% 		\item Stall events at coverage edges and due to handovers
	% 	\end{itemize}

		% \only<2->{\includegraphics[width=\columnwidth]{../../chapters/06-mobilestreamingmeasurements/images/R-ltesim-plotbuffer-mobility-facets.pdf}}
	% 	\only<2->{\includegraphics[width=\columnwidth]{extras/R-ltesim-plotbuffer-mobility-facets.png}}
	% \end{columns}
	% \end{overlayarea}
...
\begin{frame}
	...
	\Put(110,25){\fcolorbox{black}{white}{\Huge Questions!}}
\end{frame}
...
\begin{frame}[t,allowframebreaks]
	...
	\addtocategory{ownpub}{metzger2012research, metzger2014lossmodel,raf2013sensorium, cs3516, metzger2014jcnc, rafetseder2011explyt, 6229739, metzger2011delivery, cs3518, metzger2015ltesim}
...
\begin{frame}
	...
	\framesubtitle{Virtualized GGSN Queuing Model}
		...
		\begin{itemize}
			...
			\item[$\rightarrow$] $\color{red}M(t)/G(t)/\|\overrightarrow{c}\|_1/0$ ($|\overrightarrow{c}\|_1$: total tunnel capacity of all $s$ VMs) % 1-norm des Kapazitätsvektors
		\end{itemize}
\end{frame}
	...
	\begin{columns}[T]
		\column{0.5\textwidth}
			\begin{itemize}
				...
				%\item Demo campaign: Collect 3G coverage data and aggregate to map overlay
			\end{itemize}

		\column{0.5\textwidth}		
			\includegraphics[width=\columnwidth]{../../chapters/06-mobilestreamingmeasurements/images/sensorium-arch.pdf}\\
			\begin{itemize}
				%\item Provide sensor-reading and collection framework for smartphones to conduct ones own campaign
...
\begin{frame}
	...
	% \column{0.5\textwidth}
	% 	\only<2->{Six Threshold Window Scaling Adaptive Strategy}
