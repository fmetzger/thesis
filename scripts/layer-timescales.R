...
x <- c(10, 10, 10, 0.0000001, 0.0000001, 0.0000001, 0.0000001, 0.0000001, 0.0000001, 0.0000001, 0.0000001)
# x controls annotation position!
ymin <- 0.8:10.8
ymax <- 1.3:11.3
...
p <- p + geom_text(hjust=0, family="Linux Biolinum")
