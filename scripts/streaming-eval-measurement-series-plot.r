...
ggsave("R-playbackemulation-stallduration-loss.pdf", width=12, height=8, device=cairo_pdf)
...
ggsave("R-playbackemulation-stallnumber-loss.pdf", width=12, height=8, device=cairo_pdf)
...
ggsave("R-playbackemulation-stallduration-latency.pdf", width=12, height=8, device=cairo_pdf)
...
ggsave("R-playbackemulation-stallnumber-latency.pdf", width=12, height=8, device=cairo_pdf)
