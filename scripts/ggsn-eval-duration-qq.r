...
servingtimes <- scan("F:/uni/data/duration", dec=".")
st_dongle <- scan("F:/uni/data/duration_dongles", dec=".") 
#st_regularphone <- scan("F:/uni/data/duration_regularphone", dec=".")
st_smartphone <- scan("F:/uni/data/duration_smartphone", dec=".")
#st_symbian <- scan("F:/uni/data/duration_symbian", dec=".")
st_ios <- scan("F:/uni/data/duration_ios", dec=".")
st_android <- scan("F:/uni/data/duration_android", dec=".")
...
p <- ggplot(d) + geom_abline(intercept=0, slope=1, size=1) + geom_line(aes(x=x, y=y, color=type), size=1)
...
ggsave("R-duration-qq-category-comparison.pdf", width=12, height=10, useDingbats=F)
