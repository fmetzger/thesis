...
\begin{figure}[htbp]
%\centerline{\subfloat[Netvine, North American peak traffic (Source: \cite{sandvine_spring2011}).]{\label{fig:netvine}\includegraphics[width=3in]{netvine.png}}
%\hfil
%\subfloat[Cisco, global consumer Internet traffic prediction (Source: \cite{cisco2011VNI}).]{\label{fig:cisco}\includegraphics[width=3in]{ciscoVNI.jpg}}}
...
%\includegraphics[width=0.4\textwidth]{hv-topics-new.pdf}
...
\begin{figure}[htbp]
\centering
%\includegraphics[width=1.0\textwidth]{apparatus-new.pdf}
...
\begin{figure}[htbp] % use 1.75in each for single-column

\centering

%\subfloat[Simple playback stalling method, 33s total stalling.]{\label{fig:bufferlevel-stall}\includegraphics[width=3in]{bufferlevel-stall-new}}
\hfil
%\subfloat[Initial playback delay, 33s total stalling.]{\label{fig:bufferlevel-startdelay}\includegraphics[width=3in]{bufferlevel-startdelay-new}}\\


%\subfloat[YouTube Flash Player method, 34s total stalling.]{\label{fig:bufferlevel-flash}\includegraphics[width=3in]{bufferlevel-flash-new}}
\hfil
%\subfloat[Firefox HTML5 method, 44s total stalling.]{\label{fig:bufferlevel-firefox}\includegraphics[width=3in]{bufferlevel-firefox-new}}

\caption{Modelled buffer fill level graphs and resulting total stalling times.}
\label{fig:bufferlevel}
\end{figure}

These models were compared with regards to the stalling frequency and duration in a test scenario. The resulting graphs are depicted in Figure \ref{fig:bufferlevel}. Further research is now required to gather measurement data from several videos and QoS conditions to be able to make conclusions on the viability of the models.
