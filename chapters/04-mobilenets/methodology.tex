...
Evaluations in this chapter based on passive network traces.
However! Next chapter will also deal with approaches to conduct meaningful active device-based measurements and additionally set up a simulation/emulation testbed based on the results.
