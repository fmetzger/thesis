...
\centering
\label{c4:tab:anova}
  \begin{tabu}{X[1.6,l]X[1.7,r]X[r]X[r]X[1.1r]}
  \toprule
  & $\mathbf{F-test}$ & $\mathbf{p-value}$ & $\mathbf{\eta^2}$ & \textbf{Cohen's} $\mathbf{{\omega}^2}$\\ 
  \midrule
  \multicolumn{2}{l}{\textit{blocking probability}} & & & \\ 
  maxTunnels & $F(12, 1417)=104$ & $<0.001$ & $\color{red}0.468$ & $0.463$\\ 
  maxInstances & $F(9,1420)=9.29$ & $<0.001$ & $\color{red} 0.056$ & $0.050$\\ 
  startstopDuration & $F(4,1425)=0.21$ & $0.931$ & $<0.001$ & $0.000$\\
  \midrule
  \multicolumn{2}{l}{\textit{mean number of tunnels}}& & & \\ 
  maxTunnels & $F(12,1417)=105.7$ & $<0.001$ & $\color{red} 0.472$ & $0.467$\\ 
  maxInstances & $F(9,1420)=9.39$ & $<0.001$ & $\color{red} 0.056$ & $0.050$\\ 
  startstopDuration & $F(4,1425)=0.25$ & $0.912$ & $<0.001$ & $0.000$\\
  \bottomrule
  \end{tabu}
\end{table}
