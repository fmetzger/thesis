...
\begin{figure}[htb]
	...
	\caption{Comparison of the mean blocking probability of various server configurations. The $x$ axis depicts the summary capacity of all virtual instances in the experiment.}
...
\begin{figure}[htb]
	...
	\caption{Comparison of the mean tunnel occupation of various virtualization configurations.}
