...
%%
\subsection{\acrshort{3GPP} Radio Network}
...
%%
\subsection{\acrshort{3GPP} Core Network}
...
\gls{MME} 36.413 \cite{3gpp.36.413} S1 (\gls{eNB} - \gls{MME}) Application Protocol (LTE only)
	...
	23.203 \cite{3gpp.23.203} \gls{PCC} description (\gls{PCRF} \gls{PCEF})
...
%%
\subsection{\acrshort{GTP} and \acrshort{GTP}-based Core Network Signaling}
\label{c4:sec:gtp}
...
%%
\subsubsection{\acrshort{PDP} Context}
