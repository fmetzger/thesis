...
Figure~\ref{c4:fig:protocol stacks} overviews the complete protocol stack on the path of the user traffic through the whole network from the \gls{UE} to an external network.
...
To enact the aforementioned user and control plane separation, tunneling concepts are used.
