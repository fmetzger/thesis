...
\todo{Christian + modellierung kooperation herausheben}
...
\begin{figure}[htb]
	...
	\caption{$M/M/c/\infty$ Markov chain model.\todo{something is wrong with the figure (this is not a$ M/M/c/\infty$ model)}}
