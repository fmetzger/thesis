...
\begin{figure}[htbp]
  \centering
  \resizebox{0.6\textwidth}{!}{\input{images/model_traditional_ggsn.tex}}
...
\begin{figure}[htbp]
  \centering
  \input{images/model_nfv_ggsn.tex}
