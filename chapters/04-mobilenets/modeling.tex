...
The data does not give any indication of that being the case
This confinement could not yet be made for the trace data. Instead, a simulative approach will be taken in Section~\ref{c4:sec:simulation}.
