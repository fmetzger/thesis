...
Finally, the core network control plane load evaluations are at hand. The previously described dataset is thoroughly investigated several approaches to measure load and related factors are iterated.
...
\begin{tabu}{X[0.9,l]X[r]X[r]X[4.5,r]X[r]} 
  ...
  \midrule
  0h-5h & $10.67477$ & $0.995$ & $0.919208 - 60.6136y - 3498.78y^3 - \frac{110.707y + 2289.94y^3}{y - 1.00469}$ &  $0.999$ \\
  6h-11h & $24.53298$ & $0.992$ & $1 + 117.484y - 368.643y^2 - \frac{1720.13y^4}{y - 1.0041}$ & $0.9998$ \\
  12h-17h & $29.2504$ & $0.9925$ & $0.952566 + 69.4907y + \frac{81146.1y^3 + 1.08572\times10^6y^5}{805 - 802.01y}$ & $0.999$ \\
  18h-23h & $23.49983$ & $0.9861$ & $0.911924 + 82.0562y - \frac{2936.93y^4}{1.94468y - 1.9532}$ & $0.999$ \\
  \bottomrule
\end{tabu}
\end{table}
