...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{images/create_freq.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{images/R-createspersecond-1h-violin.pdf}
...
\begin{figure}[htb]
        ...
        \end{subfigure}
        \caption{\glspl{ECDF} of the tunnel \gls{IAT} in seconds by time of day for each day of one week.}
