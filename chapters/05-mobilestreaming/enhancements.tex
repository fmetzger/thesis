...
Moving on to the application layer, some interesting developments have occured in the Web's stack and in its use of \gls{HTTP} which almost all reliable streaming methods facilitate.
