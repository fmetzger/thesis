...
In layered network models individual functions are strictly separation and stacked on top of each other with well-defined \glspl{API} connecting them.

The timescales shown in Figure~\ref{c5:fig:timescales} partly support this notion, but also show that there are conflicts in the speed of control loops that can be implemented. 
Indeed, actual protocols and hardware need to be aware of and often explicitly exploit cross-layer influences and information flow.
