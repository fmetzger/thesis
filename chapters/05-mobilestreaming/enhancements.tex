...
SPDY~\cite{google2011SPDYdef, google2010SPDYwp} 
SPDY / \gls{HTTP}/2.0 (multiplexing -> segmented streaming)
 ...
 Widespread use and implementations in almost every browser and \gls{HTTP} server and all major cloud providers.
