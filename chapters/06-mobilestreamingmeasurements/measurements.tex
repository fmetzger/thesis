...
A purely virtual approach is the Seattle Testbed\footnote{\url{https://seattle.poly.edu/html/}}~\cite{Cappos:2009:SPE:1508865.1508905}. Again, 
real people
...
As reliable streaming is usually a fully pull-based approach, control over the server containing the streaming files is not required. 



few true mobile testbed, mostly wireless and sensor oriented (also mesh-networks), radio-focused
