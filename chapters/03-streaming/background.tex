...
But \gls{HTTP} can also be easily exploited for media streaming
%% <-- %% WIP



Video Source: Due to the nature of \gls{HTTP} more suited for stored video. But has also been successfully employed for live content
...
No multicast, but can use CDN to almost the same effect.
 ...
 \paragraph{Adaptivity and Reliability}
