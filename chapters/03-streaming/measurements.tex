...
% new method: extra libreoffice calc page, scaled to fit on one page, pdf export, cut with acrobat
    ...
    \caption{Total buffering time and exponential trend for degraded network parameter scenarios. Latency Graph.}
...
\begin{figure}[htbp]
    ...
    \caption{Total buffering time and exponential trend for degraded network parameter scenarios. Loss Graph.}
