...
\begin{figure}[htbp]
\centering
%\includegraphics[width=0.5\textwidth]{nif.pdf}
...
%\includegraphics[width=0.9\textwidth]{streaming-transfer-modes.pdf}
...
\noindent\makebox[\textwidth]{\subfloat[Overall graph.]{\label{fig:blocktransfer-overall}\includegraphics[width=3in]{images/blocktransfer-mod.pdf}}
\hfil 
\subfloat[Detail plot of the rate-limited block-sending phase.]{\label{fig:blocktransfer-detail}\includegraphics[width=3in]{images/blocktransferdetail.pdf}}}
...
\subfloat[Latency Graph.]{\label{fig:delayseries}\includegraphics[height=1.85in]{images/delay.pdf}}
\hfil
\subfloat[Loss Graph.]{\label{fig:lossseries}\includegraphics[height=1.85in]{images/loss.pdf}}}
...
The remainder of this paper is structured as follows. Section \ref{sec:relatedwork} reviews related work. Section \ref{sec:analysis} discusses issues arising from different (and multiple) parts of the network stack. In Section \ref{sec:appbehavior}, we take a closer look at the buffering and playback behavior on both the theoretical and practical side of things. Our testbed approach is described in Section \ref{sec:testbed} and evaluated in Section \ref{sec:evaluations}, where we conduct an exemplary measurement and modeling campaign on the popular YouTube platform. Section \ref{sec:conclusion-PV} wraps up the paper.

\section{Related Work}
\label{sec:relatedwork-PV}
...
\begin{figure}[!t] % use 1.75in each for single-column
\includegraphics[width=\columnwidth]{images/measurement-model.pdf}
...
\begin{figure*}[!t] % use 1.75in each for single-column
\noindent\makebox[\textwidth]{\subfloat[Total stalling time]{\label{fig:eval-latency-stallingtime}\includegraphics[width=\columnwidth]{images/eval-latency-stallingtime.pdf}}
\hfil
\subfloat[Number of stalls]{\label{fig:eval-latency-numstalls}\includegraphics[width=\columnwidth]{images/eval-latency-frequency.pdf}}}
...
\begin{figure*}[!t] % use 1.75in each for single-column
% used yt-delay/hPUGNCIozp0_delay_100 2, spyder with matplotlib config patch
\noindent\makebox[\textwidth]{\subfloat[Total stalling time]{\label{fig:eval-loss-stallingtime}\includegraphics[width=\columnwidth]{images/eval-loss4mb-stallingtime.pdf}}
\hfil
\subfloat[Number of stalls]{\label{fig:eval-loss-numstalls}\includegraphics[width=\columnwidth]{images/eval-loss4mb-frequency.pdf}}}
