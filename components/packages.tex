...
\usepackage[defernumbers=true, style=alphabetic, firstinits=true, backend=biber, doi=true, url=true, block=ragged, maxnames=6]{biblatex} % 
...
\usepackage[acronym, nomain, style=tree, hyperfirst=false, toc, section=chapter]{glossaries}
