...
\newacronym{CGN}{CGN}{Carrier-grade NAT}
...
\newacronym{GERAN}{GERAN}{\gls{GSM}/\gls{EDGE} Radio Access Network}
...
\newacronym{GTP-C}{GTP-C}{\gls{gtp} Control}
\newacronym{GTP-U}{GTP-U}{\gls{gtp} User}
\newacronym{gtpv2}{GTPv2}{\gls{gtp} version 2}
...
\newacronym{IPv4}{IPv4}{\gls{IP} version 4}
\newacronym{IPv6}{IPv6}{\gls{IP} version 6}
...
\newacronym{PMIPv6}{PMIPv6}{Proxy Mobile \gls{IPv6}}
...
\newacronym{URA}{URA}{\gls{UTRAN} Registration Area}
\newacronym{URAPCH}{URA\_PCH}{\gls{URA} Paging Channel}
